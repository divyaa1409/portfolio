    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'GAMES' ?
            <ToggleButton active value="GAMES" onClick={() => setToggle('GAMES')}>Android app</ToggleButton>
            :
            <ToggleButton value="GAMES" onClick={() => setToggle('GAMES')}>Android app</ToggleButton>
          }
          <Divider />
          {toggle === 'AI/ML' ?
